...
public class AckSent implements org.apache.thrift.TBase<AckSent, AckSent._Fields>, java.io.Serializable, Cloneable, Comparable<AckSent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AckSent");
  ...
  private static final org.apache.thrift.protocol.TField TOPIC_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("topicId", org.apache.thrift.protocol.TType.I32, (short)3);
  private static final org.apache.thrift.protocol.TField SESSION_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("sessionType", org.apache.thrift.protocol.TType.BYTE, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new AckSentStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AckSentTupleSchemeFactory());
  }
  ...
  private static final int __SESSIONTYPE_ISSET_ID = 3;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AckSent.class, metaDataMap);
  }
  ...
  public AckSent deepCopy() {
    return new AckSent(this);
  }
  ...
  public AckSent setSeq(long seq) {
    this.seq = seq;
    setSeqIsSet(true);
    return this;
  }
  ...
  public AckSent setTopicId(int topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public AckSent setSessionType(byte sessionType) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AckSent)
      return this.equals((AckSent)that);
    return false;
  }

  public boolean equals(AckSent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AckSent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AckSent(");
    boolean first = true;
  ...
  private static class AckSentStandardSchemeFactory implements SchemeFactory {
    public AckSentStandardScheme getScheme() {
      return new AckSentStandardScheme();
    }
  }

  private static class AckSentStandardScheme extends StandardScheme<AckSent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AckSent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AckSent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AckSentTupleSchemeFactory implements SchemeFactory {
    public AckSentTupleScheme getScheme() {
      return new AckSentTupleScheme();
    }
  }

  private static class AckSentTupleScheme extends TupleScheme<AckSent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AckSent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AckSent struct) throws org.apache.thrift.TException {
