...
public class AckPlay implements org.apache.thrift.TBase<AckPlay, AckPlay._Fields>, java.io.Serializable, Cloneable, Comparable<AckPlay> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AckPlay");
  ...
  static {
    schemes.put(StandardScheme.class, new AckPlayStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AckPlayTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AckPlay.class, metaDataMap);
  }
  ...
  public AckPlay deepCopy() {
    return new AckPlay(this);
  }
  ...
  public AckPlay setSeq(long seq) {
    this.seq = seq;
    setSeqIsSet(true);
    return this;
  }
  ...
  public AckPlay setSessionType(byte sessionType) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AckPlay)
      return this.equals((AckPlay)that);
    return false;
  }

  public boolean equals(AckPlay that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AckPlay other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AckPlay(");
    boolean first = true;
  ...
  private static class AckPlayStandardSchemeFactory implements SchemeFactory {
    public AckPlayStandardScheme getScheme() {
      return new AckPlayStandardScheme();
    }
  }

  private static class AckPlayStandardScheme extends StandardScheme<AckPlay> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AckPlay struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AckPlay struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AckPlayTupleSchemeFactory implements SchemeFactory {
    public AckPlayTupleScheme getScheme() {
      return new AckPlayTupleScheme();
    }
  }

  private static class AckPlayTupleScheme extends TupleScheme<AckPlay> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AckPlay struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AckPlay struct) throws org.apache.thrift.TException {
