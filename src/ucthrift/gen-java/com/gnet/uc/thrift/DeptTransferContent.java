...
public class DeptTransferContent implements org.apache.thrift.TBase<DeptTransferContent, DeptTransferContent._Fields>, java.io.Serializable, Cloneable, Comparable<DeptTransferContent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DeptTransferContent");
  ...
  private static final org.apache.thrift.protocol.TField DEPT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("dept_id", org.apache.thrift.protocol.TType.I32, (short)4);
  private static final org.apache.thrift.protocol.TField OLD_DEPT_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("old_dept_name", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  static {
    schemes.put(StandardScheme.class, new DeptTransferContentStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeptTransferContentTupleSchemeFactory());
  }
  ...
  public String old_dept_name; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DEPT_ID((short)4, "dept_id"),
    OLD_DEPT_NAME((short)5, "old_dept_name"),
  ...
  private static final _Fields optionals[] = {_Fields.OLD_DEPT_NAME,_Fields.DESC};
  ...
  static {
    ...
    tmpMap.put(_Fields.DEPT_ID, new org.apache.thrift.meta_data.FieldMetaData("dept_id", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.OLD_DEPT_NAME, new org.apache.thrift.meta_data.FieldMetaData("old_dept_name", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DeptTransferContent.class, metaDataMap);
  }

  public DeptTransferContent() {
  }
   ...
   */
  public DeptTransferContent(DeptTransferContent other) {
  ...
  public DeptTransferContent deepCopy() {
    return new DeptTransferContent(this);
  }
  ...
  public DeptTransferContent setOperator_id(int operator_id) {
    this.operator_id = operator_id;
    setOperator_idIsSet(true);
    return this;
  }
  ...
  public DeptTransferContent setUser_id(int user_id) {
    this.user_id = user_id;
    setUser_idIsSet(true);
    return this;
  }
  ...
  public DeptTransferContent setUser_name(String user_name) {
    this.user_name = user_name;
    return this;
  }
  ...
  public DeptTransferContent setDept_id(int dept_id) {
    this.dept_id = dept_id;
    setDept_idIsSet(true);
    return this;
  }
  ...
  public DeptTransferContent setOld_dept_name(String old_dept_name) {
  ...
  public DeptTransferContent setDept_name(String dept_name) {
    this.dept_name = dept_name;
    return this;
  }
  ...
  public DeptTransferContent setDesc(String desc) {
    this.desc = desc;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeptTransferContent)
      return this.equals((DeptTransferContent)that);
    return false;
  }

  public boolean equals(DeptTransferContent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeptTransferContent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeptTransferContent(");
    boolean first = true;
  ...
  private static class DeptTransferContentStandardSchemeFactory implements SchemeFactory {
    public DeptTransferContentStandardScheme getScheme() {
      return new DeptTransferContentStandardScheme();
    }
  }

  private static class DeptTransferContentStandardScheme extends StandardScheme<DeptTransferContent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DeptTransferContent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DeptTransferContent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DeptTransferContentTupleSchemeFactory implements SchemeFactory {
    public DeptTransferContentTupleScheme getScheme() {
      return new DeptTransferContentTupleScheme();
    }
  }

  private static class DeptTransferContentTupleScheme extends TupleScheme<DeptTransferContent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DeptTransferContent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DeptTransferContent struct) throws org.apache.thrift.TException {
