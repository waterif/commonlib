...
public class IQReceiveContent implements org.apache.thrift.TBase<IQReceiveContent, IQReceiveContent._Fields>, java.io.Serializable, Cloneable, Comparable<IQReceiveContent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("IQReceiveContent");
  ...
  private static final org.apache.thrift.protocol.TField FORWARD_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("forwardUserID", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  private static final org.apache.thrift.protocol.TField HOST_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("hostId", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  private static final org.apache.thrift.protocol.TField PARENT_EVENT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("parentEventId", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField ORI_START_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("oriStartTime", org.apache.thrift.protocol.TType.I32, (short)9);
  ...
  static {
    schemes.put(StandardScheme.class, new IQReceiveContentStandardSchemeFactory());
    schemes.put(TupleScheme.class, new IQReceiveContentTupleSchemeFactory());
  }

  public int confId; // required
  public int shareUserID; // optional
  public int forwardUserID; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FORWARD_USER_ID((short)3, "forwardUserID"),
    START_TIME((short)4, "startTime"),
    HOST_ID((short)5, "hostId"),
    EVENT_ID((short)7, "eventId"),
    PARENT_EVENT_ID((short)8, "parentEventId"),
    ORI_START_TIME((short)9, "oriStartTime"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 7: // EVENT_ID
          return EVENT_ID;
        case 8: // PARENT_EVENT_ID
          return PARENT_EVENT_ID;
        case 9: // ORI_START_TIME
  ...
  private static final _Fields optionals[] = {_Fields.SHARE_USER_ID,_Fields.FORWARD_USER_ID,_Fields.START_TIME,_Fields.EVENT_ID,_Fields.PARENT_EVENT_ID,_Fields.ORI_START_TIME,_Fields.ICALENDAR};
  ...
  static {
    ...
    tmpMap.put(_Fields.SHARE_USER_ID, new org.apache.thrift.meta_data.FieldMetaData("shareUserID", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.FORWARD_USER_ID, new org.apache.thrift.meta_data.FieldMetaData("forwardUserID", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(IQReceiveContent.class, metaDataMap);
  }

  public IQReceiveContent() {
  }
   ...
   */
  public IQReceiveContent(IQReceiveContent other) {
    __isset_bitfield = other.__isset_bitfield;
    this.confId = other.confId;
    this.shareUserID = other.shareUserID;
    this.forwardUserID = other.forwardUserID;
  ...
  public IQReceiveContent deepCopy() {
    return new IQReceiveContent(this);
  }
  ...
  public IQReceiveContent setConfId(int confId) {
    this.confId = confId;
    setConfIdIsSet(true);
    return this;
  }
  ...
  public IQReceiveContent setShareUserID(int shareUserID) {
  ...
  public IQReceiveContent setForwardUserID(int forwardUserID) {
  ...
  public void unsetForwardUserID() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FORWARDUSERID_ISSET_ID);
  }

  /** Returns true if field forwardUserID is set (has been assigned a value) and false otherwise */
  public boolean isSetForwardUserID() {
    return EncodingUtils.testBit(__isset_bitfield, __FORWARDUSERID_ISSET_ID);
  }

  public void setForwardUserIDIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FORWARDUSERID_ISSET_ID, value);
  }
  ...
  public IQReceiveContent setStartTime(int startTime) {
  ...
  public IQReceiveContent setHostId(int hostId) {
    this.hostId = hostId;
    setHostIdIsSet(true);
    return this;
  }
  ...
  public IQReceiveContent setEventId(long eventId) {
  ...
  public IQReceiveContent setParentEventId(long parentEventId) {
  ...
  public IQReceiveContent setOriStartTime(int oriStartTime) {
  ...
  public IQReceiveContent setIcalendar(String icalendar) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FORWARD_USER_ID:
      if (value == null) {
        ...
        setForwardUserID((Integer)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof IQReceiveContent)
      return this.equals((IQReceiveContent)that);
    return false;
  }

  public boolean equals(IQReceiveContent that) {
    if (that == null)
      return false;
    ...
    boolean this_present_forwardUserID = true && this.isSetForwardUserID();
    boolean that_present_forwardUserID = true && that.isSetForwardUserID();
    if (this_present_forwardUserID || that_present_forwardUserID) {
      if (!(this_present_forwardUserID && that_present_forwardUserID))
        return false;
      if (this.forwardUserID != that.forwardUserID)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_forwardUserID = true && (isSetForwardUserID());
    list.add(present_forwardUserID);
    if (present_forwardUserID)
      list.add(forwardUserID);
  ...
  @Override
  public int compareTo(IQReceiveContent other) {
    ...
    lastComparison = Boolean.valueOf(isSetForwardUserID()).compareTo(other.isSetForwardUserID());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetForwardUserID()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.forwardUserID, other.forwardUserID);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("IQReceiveContent(");
    boolean first = true;
  ...
  private static class IQReceiveContentStandardSchemeFactory implements SchemeFactory {
    public IQReceiveContentStandardScheme getScheme() {
      return new IQReceiveContentStandardScheme();
    }
  }

  private static class IQReceiveContentStandardScheme extends StandardScheme<IQReceiveContent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, IQReceiveContent struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // FORWARD_USER_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.forwardUserID = iprot.readI32();
              struct.setForwardUserIDIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IQReceiveContent struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetForwardUserID()) {
        oprot.writeFieldBegin(FORWARD_USER_ID_FIELD_DESC);
        oprot.writeI32(struct.forwardUserID);
        oprot.writeFieldEnd();
      }
  ...
  private static class IQReceiveContentTupleSchemeFactory implements SchemeFactory {
    public IQReceiveContentTupleScheme getScheme() {
      return new IQReceiveContentTupleScheme();
    }
  }

  private static class IQReceiveContentTupleScheme extends TupleScheme<IQReceiveContent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IQReceiveContent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IQReceiveContent struct) throws org.apache.thrift.TException {
