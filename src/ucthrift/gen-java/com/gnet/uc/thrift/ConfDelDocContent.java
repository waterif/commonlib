...
public class ConfDelDocContent implements org.apache.thrift.TBase<ConfDelDocContent, ConfDelDocContent._Fields>, java.io.Serializable, Cloneable, Comparable<ConfDelDocContent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ConfDelDocContent");
  ...
  private static final org.apache.thrift.protocol.TField EVENT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("eventId", org.apache.thrift.protocol.TType.I64, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ConfDelDocContentStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ConfDelDocContentTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ConfDelDocContent.class, metaDataMap);
  }

  public ConfDelDocContent() {
  }
   ...
   */
  public ConfDelDocContent(ConfDelDocContent other) {
  ...
  public ConfDelDocContent deepCopy() {
    return new ConfDelDocContent(this);
  }
  ...
  public ConfDelDocContent setOperatorid(long operatorid) {
    this.operatorid = operatorid;
    setOperatoridIsSet(true);
    return this;
  }
  ...
  public ConfDelDocContent setDoc_name(String doc_name) {
    this.doc_name = doc_name;
    return this;
  }
  ...
  public ConfDelDocContent setContentId(long contentId) {
    this.contentId = contentId;
    setContentIdIsSet(true);
    return this;
  }
  ...
  public ConfDelDocContent setEventId(long eventId) {
    this.eventId = eventId;
    setEventIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ConfDelDocContent)
      return this.equals((ConfDelDocContent)that);
    return false;
  }

  public boolean equals(ConfDelDocContent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ConfDelDocContent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ConfDelDocContent(");
    boolean first = true;
  ...
  private static class ConfDelDocContentStandardSchemeFactory implements SchemeFactory {
    public ConfDelDocContentStandardScheme getScheme() {
      return new ConfDelDocContentStandardScheme();
    }
  }

  private static class ConfDelDocContentStandardScheme extends StandardScheme<ConfDelDocContent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ConfDelDocContent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ConfDelDocContent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ConfDelDocContentTupleSchemeFactory implements SchemeFactory {
    public ConfDelDocContentTupleScheme getScheme() {
      return new ConfDelDocContentTupleScheme();
    }
  }

  private static class ConfDelDocContentTupleScheme extends TupleScheme<ConfDelDocContent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ConfDelDocContent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ConfDelDocContent struct) throws org.apache.thrift.TException {
