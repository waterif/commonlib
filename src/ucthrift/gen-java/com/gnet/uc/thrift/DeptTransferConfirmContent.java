...
public class DeptTransferConfirmContent implements org.apache.thrift.TBase<DeptTransferConfirmContent, DeptTransferConfirmContent._Fields>, java.io.Serializable, Cloneable, Comparable<DeptTransferConfirmContent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DeptTransferConfirmContent");
  ...
  static {
    schemes.put(StandardScheme.class, new DeptTransferConfirmContentStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeptTransferConfirmContentTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DeptTransferConfirmContent.class, metaDataMap);
  }

  public DeptTransferConfirmContent() {
  }
   ...
   */
  public DeptTransferConfirmContent(DeptTransferConfirmContent other) {
  ...
  public DeptTransferConfirmContent deepCopy() {
    return new DeptTransferConfirmContent(this);
  }
  ...
  public DeptTransferConfirmContent setOperator_id(int operator_id) {
    this.operator_id = operator_id;
    setOperator_idIsSet(true);
    return this;
  }
  ...
  public DeptTransferConfirmContent setUser_name(String user_name) {
    this.user_name = user_name;
    return this;
  }
  ...
  public DeptTransferConfirmContent setDept_id(int dept_id) {
  ...
  public DeptTransferConfirmContent setDept_name(String dept_name) {
    this.dept_name = dept_name;
    return this;
  }
  ...
  public DeptTransferConfirmContent setUser_id(int user_id) {
    this.user_id = user_id;
    setUser_idIsSet(true);
    return this;
  }
  ...
  public DeptTransferConfirmContent setDesc(String desc) {
    this.desc = desc;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeptTransferConfirmContent)
      return this.equals((DeptTransferConfirmContent)that);
    return false;
  }

  public boolean equals(DeptTransferConfirmContent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeptTransferConfirmContent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeptTransferConfirmContent(");
    boolean first = true;
  ...
  private static class DeptTransferConfirmContentStandardSchemeFactory implements SchemeFactory {
    public DeptTransferConfirmContentStandardScheme getScheme() {
      return new DeptTransferConfirmContentStandardScheme();
    }
  }

  private static class DeptTransferConfirmContentStandardScheme extends StandardScheme<DeptTransferConfirmContent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DeptTransferConfirmContent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DeptTransferConfirmContent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DeptTransferConfirmContentTupleSchemeFactory implements SchemeFactory {
    public DeptTransferConfirmContentTupleScheme getScheme() {
      return new DeptTransferConfirmContentTupleScheme();
    }
  }

  private static class DeptTransferConfirmContentTupleScheme extends TupleScheme<DeptTransferConfirmContent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DeptTransferConfirmContent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DeptTransferConfirmContent struct) throws org.apache.thrift.TException {
