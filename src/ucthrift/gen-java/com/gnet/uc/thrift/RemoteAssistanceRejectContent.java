...
public class RemoteAssistanceRejectContent implements org.apache.thrift.TBase<RemoteAssistanceRejectContent, RemoteAssistanceRejectContent._Fields>, java.io.Serializable, Cloneable, Comparable<RemoteAssistanceRejectContent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoteAssistanceRejectContent");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoteAssistanceRejectContentStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RemoteAssistanceRejectContentTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoteAssistanceRejectContent.class, metaDataMap);
  }

  public RemoteAssistanceRejectContent() {
  }
   ...
   */
  public RemoteAssistanceRejectContent(RemoteAssistanceRejectContent other) {
  ...
  public RemoteAssistanceRejectContent deepCopy() {
    return new RemoteAssistanceRejectContent(this);
  }
  ...
  public RemoteAssistanceRejectContent setConfId(String confId) {
    this.confId = confId;
    return this;
  }
  ...
  public RemoteAssistanceRejectContent setControlType(int controlType) {
    this.controlType = controlType;
    setControlTypeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoteAssistanceRejectContent)
      return this.equals((RemoteAssistanceRejectContent)that);
    return false;
  }

  public boolean equals(RemoteAssistanceRejectContent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RemoteAssistanceRejectContent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RemoteAssistanceRejectContent(");
    boolean first = true;
  ...
  private static class RemoteAssistanceRejectContentStandardSchemeFactory implements SchemeFactory {
    public RemoteAssistanceRejectContentStandardScheme getScheme() {
      return new RemoteAssistanceRejectContentStandardScheme();
    }
  }

  private static class RemoteAssistanceRejectContentStandardScheme extends StandardScheme<RemoteAssistanceRejectContent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoteAssistanceRejectContent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoteAssistanceRejectContent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RemoteAssistanceRejectContentTupleSchemeFactory implements SchemeFactory {
    public RemoteAssistanceRejectContentTupleScheme getScheme() {
      return new RemoteAssistanceRejectContentTupleScheme();
    }
  }

  private static class RemoteAssistanceRejectContentTupleScheme extends TupleScheme<RemoteAssistanceRejectContent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoteAssistanceRejectContent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoteAssistanceRejectContent struct) throws org.apache.thrift.TException {
