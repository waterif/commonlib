...
public class FileHelper
{
    ...
    public static <T> T loadXmlFromFile( String fileName, Class<T> clazz )
    {
        ...
        return XMLHelper.fromXMLString( content, clazz );
    }

    public static <T> T loadJsonFromFile( String fileName, Class<T> clazz )
    {
        String content = readTextFile( fileName );
        ...
        return JSONHelper.parseObject( content, clazz );
    }
